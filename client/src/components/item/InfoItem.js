				...
				<div class='InfoItem'>
								...
								<div class='modal-nutrition'>
                                    ...
                                    <div class="size-and-cost">
                                        ...
                                        <div class="cost-of-size-and-cost">
                                            <h6>
                                            {props.item.pricePerSizes?.[0].price} BNB 
                                            </h6>                                       
                                        </div>
                                    ...
                                    <div class="size-and-cost">
                                        ...
                                        <div class="cost-of-size-and-cost">
                                            <h6>
                                            {props.item.pricePerSizes?.[1].price} BNB 
                                            </h6>                                       
                                        </div>
                                    ...
                                    <div class="size-and-cost">
                                        ...
                                        <div class="cost-of-size-and-cost">
                                            <h6>
                                            {props.item.pricePerSizes?.[2].price} BNB
                                            </h6>                                       
                                        </div>
					...
					<div class='option-item'>
						...
						<div class='wallet-dollar-cost'>
							...
							<div class='cost'>
								<span>{props.item.pricePerSizes?.[0].price} BNB</span>
							</div>
						</div>
